...
def main():
    ...
    parser.add_argument("--keep-count", type=int, metavar="N",
                        help="keep compressed files and delete the others")
    parser.add_argument("--reserved-size", type=int, metavar="SIZE",
                        help="delete old compressed files to allocate free area (GiB)")
    parser.add_argument("--exclude-from", action="append", default=[], metavar="FILE",
                        help="Exclude list file (multiple times) (see rcync --exclude-from option)")
    parser.add_argument("--dump-command", action="store", default="mariadb-dump", metavar="CMD",
                        help="DB dump command (default=mariadb-dump)")
    parser.add_argument("--db", action="store",
                        help="database name (backup if specified)")
